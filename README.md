...
```shell
npm install @brightspace-ui-labs/attendance
```
...
```html
<script type="module">
    import '@brightspace-ui-labs/attendance/attendance.js';
</script>
<d2l-labs-attendance>My element</d2l-labs-attendance>
```
...
To make your usage of `d2l-labs-attendance` accessible, use the following properties when applicable:
